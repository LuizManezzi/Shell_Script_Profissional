...
# adicionar cores ou fazer formatações.
#
...
## Checagem do tamnho do texto
if [ $num_linhas -gt $text_max_linhas ];then
	echo "Texto muito extenso, não vai caber na tela"
	exit 1
fi

### Compoẽ a linha horizontal da caixa
...
echo -ne "\033[$((caixa_linha_inicio+1));0H"		#pula p/ linha inicial
